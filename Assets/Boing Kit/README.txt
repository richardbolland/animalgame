...
Changes:
  Version 1.2.47:
   - Add BoingBehavior.HandleTeleport() and BoingBones.HandleTeleport() to handle teleportation of objects. Call them after teleporting objects to prevent sudden jumps in bouncy effects.
   - Fix materials sampling reactor fields not rendering in edit mode in HDRP in Unity 6.

  Version 1.2.46:
   - Add stock URP & HDRP stock shaders & materials made using shader graphs.
   - Null checks for when rebooting & rescanning bone chains.
