  ...
  public class BoingReactorField : BoingBase
  {
    ...
    public class ShaderPropertyIdSet
    {
      ...
      public ShaderPropertyIdSet()
      {
        ...
        FieldActive = Shader.PropertyToID("boingFieldActive");
    ...
    public bool UpdateShaderConstants(MaterialPropertyBlock props, float positionSampleMultiplier = 1.0f, float rotationSampleMultiplier = 1.0f)
    {
      if (!Application.isPlaying)
      {
        ...
        {
          m_dummyBuffer = new ComputeBuffer(1, 1024);
        }

        props.SetFloat(ShaderPropertyId.PositionSampleMultiplier, 0.0f);
        props.SetFloat(ShaderPropertyId.RotationSampleMultiplier, 0.0f);
        props.SetInt(ShaderPropertyId.FieldActive, 0);
        props.SetBuffer(ShaderPropertyId.RenderFieldParams, m_dummyBuffer);
        props.SetBuffer(ShaderPropertyId.RenderCells, m_dummyBuffer);
        return true;
      }
      ...
      props.SetInt(ShaderPropertyId.FieldActive, 1);
    ...
    public bool UpdateShaderConstants(Material material, float positionSampleMultiplier = 1.0f, float rotationSampleMultiplier = 1.0f)
    {
      if (!Application.isPlaying)
      {
        ...
        material.SetFloat(ShaderPropertyId.PositionSampleMultiplier, 0.0f);
        material.SetFloat(ShaderPropertyId.RotationSampleMultiplier, 0.0f);
        material.SetInt(ShaderPropertyId.FieldActive, 0);
        material.SetBuffer(ShaderPropertyId.RenderFieldParams, m_dummyBuffer);
        material.SetBuffer(ShaderPropertyId.RenderCells, m_dummyBuffer);
        return true;
      }
      ...
      material.SetInt(ShaderPropertyId.FieldActive, 1);
